...
describe('Req', function () {
  ...
  var partBuffer = new Buffer([
    ...
    0x04, 0x4c, 0x44, 0x41, 0x50,
    0x10, 0x02, 0x00, 0x04, 0x01, 0x02, 0x03, 0x04, 0x08, 0x01, 0x00,
  ...
  describe('#authenticate', function () {
    ...
    it('should create an authenticate request',
      function () {
        ...
        var LDAPdata = Buffer.concat([new Uint8Array([0x02, 0x00, 0x04]),
                                      options.clientChallenge,
                                      new Uint8Array([0x08, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00])]);
