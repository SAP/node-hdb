...
exports.VECTOR = {
  part: {
    ...
    buffer: new Buffer(
      ...
      '0C2007000000A4D2F0CA603FB44262CD0139EE58154500EC49C6005B73497F96184B' +
      '8C' +
      '0C0802000000004099C5' +
      '0C06010000000000' +
      '0C0C0400000001800100FFFBFF7B' +
      '0C0A03000000203F18AD59DC' +
      '0C140800000031FBA2550E080A80AB684FF22F73C078', 'hex')
  },
  types: [
  ...
  values: [
    ...
    null,
    Buffer.from("02000000004099C5", 'hex'),
    [0],
    [-0.000000059604645, 0.000000059604645, -65504, 65504],
    [1.7812479, -0.0796, -278.34],
    [-58912, 90.123781, 0.0001237891, -0.0000005892, 2389.558, -12923.00, 14708.001, 38928],
  ]
}
