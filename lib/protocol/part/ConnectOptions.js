...
function ConnectOptions() {
  ...
  // This field is sent by the server to indicate that null values are
  // supported in client info properties (for unsetting a session variable).
  // When false or absent, an empty string should be sent instead.
  this.clientInfoNullValueSupported = undefined;
  ...
  //this.dataFormatVersion = DataFormatVersion.LEVEL4;
...
ConnectOptions.prototype.KEYS = [
  ...
  common.ConnectOption.CLIENT_INFO_NULL_VALUE_SUPPORTED,
  ...
  common.ConnectOption.COMPRESSION_LEVEL_AND_FLAGS,
];
