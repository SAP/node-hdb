...
function MessageBuffer() {
  this.length = 0; //Total size of the packet excluding the message header.
  this.header = undefined;
  this.data = undefined; //The message payload, excluding the message header.
}
...
MessageBuffer.prototype.readHeader = function readHeader() {
  ...
  this.header = {
    ...
    packetOptions: buffer.readUInt8(22),
    compressionVarpartLength: buffer.readUInt32LE(24)
  };
