...
Parser.prototype.parse = function (buffer, target, done) {
...
Parser.prototype.parseParameters = function (buffer) {
...
ParserState.prototype.readLob = function readLob(type) {
  ...
  this.offset += 4;
  // offset 32
  var value = this.buffer.slice(this.offset, this.offset + chunkLength);
