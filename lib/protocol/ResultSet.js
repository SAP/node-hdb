...
var Lob = require('./Lob');
var PartAttributes = common.PartAttributes;
...
Object.defineProperties(ResultSet.prototype, {
  ...
  vectorOutputType: {
    get: function getVectorOutputType() {
      return this._settings.vectorOutputType;
    }
  }
});
...
ResultSet.prototype.createParser = function createParser(options) {
  return Parser.create(this.metadata, undefined, {
    useCesu8: this.useCesu8,
    vectorOutputType: this.vectorOutputType
  }).createTransform(this, util.extend({
...
function isLast(data) {
  ...
  return !!(data.attributes & PartAttributes.LAST_PACKET);
}

function isClosed(data) {
  /* jshint bitwise:false */
  return !!(data.attributes & PartAttributes.RESULT_SET_CLOSED);
}
