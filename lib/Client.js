...
var Connection = require('./protocol/Connection');
var Result = require('./protocol/Result');
var Statement = require('./protocol/Statement');
var ResultSet = require('./protocol/ResultSet');
...
Client.prototype.createResultSet = function createResultSet(options) {
  return new ResultSet(this._connection, options);
};