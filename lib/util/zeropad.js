...
exports.lrpad9 = function lrpad9(n) {
  if (n >= INT_10_8) return n + ZERO_0;
  if (n >= INT_10_7) return n + ZERO_1;
  if (n >= INT_10_6) return n + ZERO_2;
  if (n >= INT_10_5) return ZERO_1 + n + ZERO_2;
  if (n >= INT_10_4) return ZERO_2 + n + ZERO_2;
  if (n >= INT_10_3) return ZERO_3 + n + ZERO_2;
  if (n >= INT_10_2) return ZERO_4 + n + ZERO_2;
  if (n >= INT_10_1) return ZERO_5 + n + ZERO_2;
  return ZERO_6 + n + ZERO_2;
};
