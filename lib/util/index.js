  ...
  os_user: {
    get: function getOsUser() {
      ...
      try {
        ...
        // Unable to obtain OS user info for some reason, e.g.
        // security hardening. Silently fallback to "Unknown".
      }
      return osUsername;
    },
  },
...
function isFlagBitSet(flags, flag) {
  return (flags & flag) === flag;
 }
 exports.isFlagBitSet = isFlagBitSet;
